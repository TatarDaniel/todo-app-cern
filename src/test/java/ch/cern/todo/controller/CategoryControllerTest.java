...
public class CategoryControllerTest {
    ...
    void shouldReturnListOfCategories_whenDataExists() throws Exception {
        ...
        when(categoryService.getAllCategories(any(TaskCategoryRequestParams.class))).thenReturn(categoryResponses);
        ...
        verify(categoryService, times(1)).getAllCategories(any(TaskCategoryRequestParams.class));
    }

    @Test
    void shouldReturnEmptyList_whenNoCategoriesExist() throws Exception {
        when(categoryService.getAllCategories(any(TaskCategoryRequestParams.class))).thenReturn(Collections.emptyList());
    ...
    void shouldCreateCategory_whenValidRequest() throws Exception {
        ...
        try (final MockedStatic<SecurityUtil> mockedSecurity = mockStatic(SecurityUtil.class)) {
            ...
            when(categoryService.createCategory(any(CategoryRequest.class), eq("user")))
        ...
        verify(categoryService, times(1)).createCategory(any(CategoryRequest.class), eq("user"));
    }

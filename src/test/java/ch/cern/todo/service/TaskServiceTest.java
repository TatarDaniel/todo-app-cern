...
import ch.cern.todo.dto.TaskRequestParams;
...
class TaskServiceTest {
    ...
    void shouldReturnTasks_whenUserIsAuthorized() {
        ...
        final TaskRequestParams requestParams = new TaskRequestParams();
        ...
        final Task task = Task.builder()
                ...
                .createdBy(
                        User.builder()
                                ...
                                .build())
                .build();
        final TaskResponse taskResponse = new TaskResponse(1L, "Task 1", "Description", username, LocalDateTime.now(), "Personal");
    ...
    void shouldCreateTaskSuccessfully_whenValidRequest() {
        final String username = "user";
        final TaskRequest taskRequest = new TaskRequest("Task 1", "Description", LocalDateTime.now(),"Personal");
        ...
        final TaskResponse expectedResponse = new TaskResponse(1L, "Task 1", "Description", username, LocalDateTime.now(), "Personal");
    ...
    void shouldUpdateTaskSuccessfully_whenUserIsAuthorized() {
        ...
        final String username = "user";
        final TaskRequest taskRequest = new TaskRequest("New task", "new description", LocalDateTime.now(),"Personal");
        ...
        when(taskConvertor.convertToTaskResponse(any(Task.class)))
                .thenReturn(new TaskResponse(taskId, taskRequest.getName(), taskRequest.getDescription(), username, LocalDateTime.now(), taskRequest.getCategory()));
    ...
    void shouldThrowResourceNotFoundException_whenCategoryDoesNotExist_whenUpdating() {
        final Long taskId = 1L;
        final String username = "user";
        final TaskRequest taskRequest = new TaskRequest("New task", "new description", LocalDateTime.now(),"NonExisting Category");
    ...
    void shouldThrowEntityNotFoundException_whenTaskDoesNotExist_whenUpdating() {
        ...
        final String username = "user";
        final TaskRequest taskRequest = new TaskRequest("Updated task", "updated description", LocalDateTime.now(),"Personal");

...
class CategoryServiceTest {
    ...
    @Mock
    private TaskCategoryConvertor convertorCategory;
    ...
    void shouldReturnAllCategoriesSuccessfully() {
        final CategoryQueryParams requestParams = new CategoryQueryParams();
    ...
    void shouldCreateCategorySuccessfully() {
        ...
        final CategoryCreateRequest categoryRequest = new CategoryCreateRequest("Work", "Work-related tasks");
